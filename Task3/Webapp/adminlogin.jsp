  ...
  <body>
    ...
    <section class="flex flex-col md:flex-row h-screen items-center">
      ...
      <div class="w-full md:max-w-md lg:max-w-full md:mx-auto md:mx-0 md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
        ...
        <div class="w-full h-100">
          ...
          <p class="mt-8"><a href="login.jsp" class="text-blue-500 hover:text-blue-700 font-semibold">User Login</a></p>
        ...
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
          <div>
            ...
            <ul class="mt-8 flex gap-6">
              <li>
                <a href="https://twitter.com/iChandanW03?t=k5jwjAxmjU51jb1eZRCcog&s=09" rel="noreferrer" target="_blank"
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              ...
              <ul class="mt-6 space-y-4 text-sm">
                ...
                <li>
                  <ap class="text-gray-700 transition hover:opacity-75 dark:text-gray-200">
                    TailWind CSS
                    </p>
                </li>
    ...
    <footer class="bg-gray-900 text-center lg:text-left">
      <div class="p-4 text-center text-neutral-700 dark:text-neutral-200">
        © 2023 Copyright:
        <a class="text-neutral-800 dark:text-neutral-400" href="https://d-coder-chandan.netlify.app">Chandan Werulkar.

                ...
                <div class="flex-auto px-4 lg:px-10 py-10 pt-0 bg-gray-200">
                    ...
                    <%if(request.getAttribute("status")=="success") {%>
                                    ...
                                    <%if(request.getAttribute("status")=="failed") {%>
                                        ...
                                        <%} %>
                        <form class="space-y-6" name="frm" method="POST" action="debit">
                            <div>
                                <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">
                                    Withdraw Amount from Account</h2>
                                <label for="camount" class="block text-sm font-medium leading-6 text-gray-900">Enter
                                    Amount to Debit</label>
                                <div class="mt-2">
                                    <input id="damount" name="damount" type="number" required minlength="1"
                                        maxlength="5"
                            ...
                            <div>
                                <button type="submit" value="submit"
                                    class="flex w-full justify-center rounded-xl bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Debit</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<div class="mt-10">
    <footer class="bg-gray-900 lg:grid lg:grid-cols-5">
        <div class="relative block h-32 lg:col-span-2 lg:h-full">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29818.202613522637!2d77.71295336443286!3d20.90123981581916!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bd6bb2b898fe3d1%3A0xf953b51392c19e74!2sSai%20Nagar%2C%20Amravati%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1691571594546!5m2!1sen!2sin" class="absolute inset-0 h-full w-full object-cover" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        ...
        <div class="px-4 bg-gray-900 py-16 sm:px-6 lg:col-span-3 lg:px-8">
          <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
            <div>
              <p>
                <span
                  class="text-xs uppercase tracking-wide text-white"
                >
                  Call us
                </span>
                ...
                <a
                  href="mailto:chandanw03@gmail.com"
                  class="block text-xl font-medium text-white hover:opacity-75 sm:text-3xl"
                >
              ...
              <ul class="mt-8 flex gap-6">
                <li>
                  <a
                    href="https://twitter.com/iChandanW03?t=k5jwjAxmjU51jb1eZRCcog&s=09"
                    rel="noreferrer"
                    target="_blank"
                ...
                <li>
                  <a
                    href="https://github.com/Chandan2024"
                    rel="noreferrer"
                    target="_blank"
                    class="text-white transition hover:opacity-75 "
                  >
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <ul class="mt-6 space-y-4 text-sm">
                  <li>
                    <a
                      href="https://fit-bit-health.netlify.app"
                      class="text-white transition hover:opacity-75"
                    >
                      Fit-Bit
                    </a>
                  ...
                  <li>
                    <a
                      href="https://d-coder-chandan.netlify.app"
                      class="text-white transition hover:opacity-75"
                    >
                      PortFolio 1
                    </a>
                  ...
                  <li>
                    <a
                      href="https://d-coder-chandan-old.netlify.app"
                      class="text-white transition hover:opacity-75"
                    >
                      PortFolio 2
                    </a>
      ...
      <footer
        class="bg-gray-900 text-center lg:text-left">
        <div class="p-4 text-center text-white">
          &copy; 2023 Copyright:
          <a
            class="text-white"
            href="https://d-coder-chandan.netlify.app"
            >Chandan Werulkar. All rights reserved.</a
          >
        </div>
      </footer>
</div>
 ...
 <script src="https://cdn.jsdelivr.net/npm/sweetalert2@7.12.15/dist/sweetalert2.all.min.js"></script>
    ...
    <script>
      ...
      if (status == "complete") {
          swal("Transaction Complete", "Amount Withdrawn", "success");
        }
      if (status == "incomplete") {
        swal("Transaction incomplete", "Insufficient fund / Wrong Password", "error");
      }
    </script>

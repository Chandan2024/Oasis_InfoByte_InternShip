    ...
    <body>
      ...
      <div class="flex flex-wrap px-4">
        <div
          ...
          <img class="rounded-t-lg w-72 h-64" src="./img/manager.jpeg" alt="user" />
          <div class="p-5">
        ...
        <div
          class="max-w-sm mx-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mt-20 place-content-center">
          <img class="rounded-t-lg bg-white h-64 w-64" src="./img/transaction.png" alt="user" />
          <div class="p-5">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              Users
            </h5>
        ...
        <div
          class="max-w-sm mx-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mt-20 place-content-center">
          <img class="rounded-t-lg bg-white w-64 h-64" src="./img/manage.png" alt="user" />
          <div class="p-5">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              Transaction
            </h5>
         ...
         <div
          class="max-w-sm mx-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mt-20 place-content-center">
          <img class="rounded-t-lg bg-white w-64 h-64" src="./img/Query.png" alt="query" />
          <div class="p-5">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              Queries 
            </h5>
      ...
      <div class="mt-10">
          ...
          <div class="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
              <div>
                <p>
                  ...
                  <a href="tel:9789879283"
                    class="block text-xl font-medium text-gray-900 hover:opacity-75 dark:text-white sm:text-3xl">
                    1234567890
                  </a>
                ...
                <ul class="mt-8 flex gap-6">
                  <li>
                    <a href="https://twitter.com/iChandanW03?t=k5jwjAxmjU51jb1eZRCcog&s=09" rel="noreferrer"
                      target="_blank" class="text-gray-700 transition hover:opacity-75 dark:text-gray-200">
              ...
              <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div>
                  <p class="font-medium text-gray-900 dark:text-white">Projects</p>

                  <ul class="mt-6 space-y-4 text-sm">
                    <li>
                      <a href="https://fit-bit-health.netlify.app"
                        class="text-gray-700 transition hover:opacity-75 dark:text-gray-200">
                        Fit-Bit
                      </a>
                    </li>
        ...
        <footer class="bg-gray-900 text-center lg:text-left">
          <div class="p-4 text-center text-neutral-700 dark:text-neutral-200">
            &copy; 2023 Copyright:
            <a class="text-neutral-800 dark:text-neutral-400" href="https://d-coder-chandan.netlify.app">Chandan
              Werulkar. All rights reserved.</a>
          </div>
        </footer>
      </div>

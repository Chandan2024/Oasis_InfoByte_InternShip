  ...
  <%@ page import="java.sql.*,java.util.*" %>
    <% if(session.getAttribute("name")==null) { response.sendRedirect("login.jsp"); } %>
      ...
      <head>
        ...
        <title>Belief_Bank/Queries</title>
                ...
                <table class="items-center w-full bg-transparent border-collapse">
                  <thead>
                    <tr>
                      ...
                      <th class="w-4 px-6 align-middle border border-solid py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left bg-pink-800 text-pink-300 border-pink-700">
                        Description</th>
                  ...
                  <% Connection con; PreparedStatement stmt; ResultSet rs;  try {
                    Class.forName("com.mysql.cj.jdbc.Driver");
                    con=DriverManager.getConnection("database_url_will_here");
                    stmt=con.prepareStatement("select * from bank_query;"); 
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                         ...
                         <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                         <a href="" class="underline cursor-pointer">Edit User info</a>
                        </td>
